                  ...
                  child: Column(
                    children: [
                      _buildMenuItem(
                        ...
                        context: context,
                        onTap: () => Navigator.pushNamed(context,Favourite_List.routeName),
                      ),
                      ...
                      _buildMenuItem(
                        ...
                        context: context,
                        onTap: () => Navigator.pushNamed(context,Location.routeName),
                      ),
                      Divider(color: Theme.of(context).scaffoldBackgroundColor),
                      _buildMenuItem(
                        ...
                        context: context,
                        onTap: () => Navigator.pushNamed(context,MyReviews.routeName),
                      ),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      _buildMenuItem(
                        ...
                        context: context,
                        onTap: () => Navigator.pushNamed(context,Appdetails.routeName),
                      ),
                      Divider(color: Theme.of(context).scaffoldBackgroundColor),
                      _buildMenuItem(
                        ...
                        context: context,
                        onTap: () => Navigator.pushNamed(context,RateUs.routeName),
                      ),
                      Divider(color: Theme.of(context).scaffoldBackgroundColor),
                      _buildMenuItem(
                        icon: Icons.share,
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            shape: BoxShape.circle,
                            color: Colors.red.withOpacity(0.2), // Background color for the avatar
                          ),
                          child: Icon(
                            Icons.logout_outlined, // Replace with an image if available
                            color: Colors.red,
                            size: 28,
                          ),
                        ),
