        ...
        child: Column(
          children: [
                        ...
                        child: AnimatedContainer(
                          ...
                          child: AnimatedSwitcher(
                            ...
                            child: like
                                ? Icon(
                              Icons.favorite,
                              key: ValueKey<bool>(like), // Unique key to differentiate icons
                              color: Colors.white,
                            )
                                : Icon(
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Spacer(),
                            Text("View More",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: app_Colors_Light.MainColor),)
                          ],
                        ),
                        Padding(
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 10,),
                            Text("Zeayd Nabawy",style: Theme.of(context).textTheme.bodyMedium,),
                            Spacer(),
                            Icon(FontAwesomeIcons.solidStar,color: app_Colors_Light.Rate_color,size: 10,),
                            SizedBox(width: 3,),
                            Icon(FontAwesomeIcons.solidStar,color: app_Colors_Light.Rate_color,size: 10,),
                            SizedBox(width: 3,),
                            Icon(FontAwesomeIcons.solidStar,color: app_Colors_Light.Rate_color,size: 10,),
                            SizedBox(width: 3,),
                            Text("3.0",style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 13),)
                        ...
                        Row(
                          children: [
                            ...
                            Spacer(),
                            Text("250 ",style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: app_Colors_Light.MainColor,)),
                            Text("services",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: app_Colors_Light.MainColor),)
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text("Also provided below services",style: Theme.of(context).textTheme.bodyMedium,),
                  Spacer(),
                  InkWell(
                      onTap: () => Navigator.pushNamed(context,AllReviewsScreen.routeName),
                      child: Text("View all",style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: app_Colors_Light.MainColor),))
