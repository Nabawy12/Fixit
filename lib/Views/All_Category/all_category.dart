...
class _AllCategoryState extends State<AllCategory> {
  ...
  bool isListView = false; // State variable to toggle between GridView and ListView
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(
                        isListView ?
                         Icons.category_outlined : Icons.list ,
                ...
                child: isListView
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Row(
                        children: [
                        Icon(services[index]['icon'],color: Theme.of(context).textTheme.bodySmall!.color,),
                       SizedBox(width: 10,),
                       Text(services[index]['label'],style: Theme.of(context).textTheme.bodyMedium,),
                       Spacer(),
                       Icon(Icons.arrow_forward_ios_outlined,color: Theme.of(context).textTheme.bodySmall!.color,)
